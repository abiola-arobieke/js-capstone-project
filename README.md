...
**Javascript Capstone Project** is a Simple Project to Display Javascript Capstone Project
...
```sh
  git clone https://github.com/abiola-arobieke/js-capstone-project.git
```
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/js-capstone-project/issues).
...
We would like to thank to the Microverse team for the learning opportunity
