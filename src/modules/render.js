                            ...
                            <div class="modal-info">
                                <div id="recipe-info">
                                    <div id="modal-detail">
                                        ...
                                        <div class="py-10">${recipe.description}</div>
                                        <div class="grid-2">
                                          ${recipe.calorie ? `<div class="py-10">Calorie: ${recipe.calorie}</div>` : ''}
                                          ${recipe.mainIngredient ? `<div class="py-10">Main Ingredient: ${recipe.mainIngredient}</div>` : ''}
                                          ${recipe.cholesterol ? `<div class="py-10">Cholesterol: ${recipe.cholesterol}</div>` : ''}
                                          ${recipe.fat ? `<div class="py-10">Fat: ${recipe.fat}</div>` : ''}
                                          ${recipe.protein ? `<div class="py-10">Protein: ${recipe.protein}</div>` : ''}
                                          ${recipe.carbohydrate ? `<div class="py-10">Carbohydate: ${recipe.carbohydrate}</div>` : ''}
                                          ${recipe.fibre ? `<div class="py-10">Fibre: ${recipe.fibre}</div>` : ''}
                                          ${recipe.cookTime ? `<div class="py-10">Cook Time: ${recipe.cookTime} mins</div>` : ''}                                            
                                        </div> 
                                        ${recipe.ingredients ? `<div class="py-10">
                                        <h5 class="ft-18 py-10 capitalize text-center">Ingredient</h5> 
                                        <div class="py-10">${recipe.ingredients} mins</div>
                                        </div> ` : '<div></div>'}
                                        ${recipe.directions ? `<div class="py-10">
                                        <h5 class="ft-18 py-10 capitalize text-center">Direction</h5> 
                                        <div class="py-10">${recipe.directions} mins</div>
                                    </div> ` : '<div></div>'}
                                    </div> 
                                </div>
